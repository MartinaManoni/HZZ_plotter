...
eos_path_template = '/eos/cms/store/group/phys_higgs/cmshzz4l/cjlst/HIG-25-015/RunIII_byZ1Z2/Moriond26_JES/FAKERATES_2J/{}_2J/'
branches_ZX = [
    "jet_idx",
    "ZZMass",
    "Z1Flav",
...
def zx():
    ...
    for year in years:
        ...
        output_file = f"ZX_results_{year}_Njets_FIX.root"
